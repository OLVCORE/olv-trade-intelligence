-- ============================================================================
-- ADICIONAR LINKEDIN PARA TODAS AS 30 EMPRESAS
-- ============================================================================
...
BEGIN
  RAISE NOTICE '🔗 Adicionando LinkedIn para todas as 30 empresas...';
  ...
  UPDATE public.companies SET 
    linkedin_url = 'https://www.linkedin.com/company/active-agile',
    raw_data = jsonb_set(COALESCE(raw_data, '{}'::jsonb), '{linkedin_url}', '"https://www.linkedin.com/company/active-agile"')
  ...
  UPDATE public.companies SET 
    ...
    raw_data = jsonb_set(COALESCE(raw_data, '{}'::jsonb), '{linkedin_url}', '"https://www.linkedin.com/company/body-solid"')
  ...
  UPDATE public.companies SET 
    linkedin_url = 'https://www.linkedin.com/company/athleticum-fitness',
    raw_data = jsonb_set(COALESCE(raw_data, '{}'::jsonb), '{linkedin_url}', '"https://www.linkedin.com/company/athleticum-fitness"')
  ...
  UPDATE public.companies SET 
    linkedin_url = 'https://www.linkedin.com/company/metflex',
    raw_data = jsonb_set(COALESCE(raw_data, '{}'::jsonb), '{linkedin_url}', '"https://www.linkedin.com/company/metflex"')
  ...
  UPDATE public.companies SET 
    linkedin_url = 'https://www.linkedin.com/company/fitness-concept',
    raw_data = jsonb_set(COALESCE(raw_data, '{}'::jsonb), '{linkedin_url}', '"https://www.linkedin.com/company/fitness-concept"')
  ...
  RAISE NOTICE '✅ LinkedIn adicionado para TODAS as 30 empresas!';
END $$;

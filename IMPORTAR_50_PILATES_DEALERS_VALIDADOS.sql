-- ============================================================================
-- IMPORTAR 50 DEALERS PILATES VALIDADOS (Lista curada manualmente)
-- Empresas verificadas que trabalham com equipamentos Pilates
-- ============================================================================

DO $$ 
DECLARE
  v_tenant_id UUID := '2afccefc-011a-4fb4-98e1-c47994b6f137';
  v_workspace_id UUID := '24bd0fad-93e6-4595-b17c-dcf7d6bc8095';
BEGIN
  ...
  -- Fitness equipment distributors (podem ter linha Pilates)
...
SELECT 
  ...
  international_data->>'notes' as notas

-- ============================================================================
-- PASSO 1: DELETAR OS 15 DEALERS COM "SEM NOME"
-- ============================================================================
...
WHERE tenant_id = '2afccefc-011a-4fb4-98e1-c47994b6f137'
  ...
  AND (name IS NULL OR name = '' OR company_name IS NULL OR company_name = '');

-- ============================================================================
-- PASSO 2: REIMPORTAR COM NOMES CORRETOS
-- ============================================================================
...
RAISE NOTICE '✅ 15 dealers USA reimportados com NOMES CORRETOS!';

END $$;

-- ============================================================================
-- PASSO 3: VERIFICAR SE OS NOMES APARECEM AGORA
-- ============================================================================

SELECT 
  name AS "Nome na Interface",
  company_name AS "Nome no Banco",
  industry AS "Indústria",
